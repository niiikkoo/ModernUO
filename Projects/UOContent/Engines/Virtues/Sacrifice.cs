...
namespace Server
{
    public static class SacrificeVirtue
    {
        ...
        public static bool CanGain(VirtueInfo info) => Core.Now >= info.LastSacrificeGain + GainDelay;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool CanAtrophy(VirtueInfo info) => info?.LastSacrificeLoss + LossDelay < Core.Now;
